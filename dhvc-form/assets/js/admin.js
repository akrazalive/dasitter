...
(function ($) {
	...
	var form_action = function(select){
		...
		}else if(select.val() == 'mailchimp'){
			mailchimp_list_field.show();
		}
	}
	...
	$('.dhvc-form-action,.dhvc-form-action2').on('click',function(){
	...
	$('.dhvc-form-entry-select-action').on('change',function(){
		$('#dhvc_form_entry').submit();
	});
	
	$('#dhvcform-actions input, #dhvcform-actions a').on('click',function(){
