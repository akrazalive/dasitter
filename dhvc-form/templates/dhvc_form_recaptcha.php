...
if($captcha_type=='3'){	
	...
	$output .= '<input type="hidden" id="g-recaptcha-response_'.$name.'" name="g-recaptcha-response" class="dhvc-form-recaptcha" data-name="'.$name.'" value="">';
}else{
	...
	if($captcha_type == '2'){
		...
		if ( ! empty( $site_key ) && ! empty( $secret_key ) ) {
			...
			$output .='<div type="recaptcha" data-dhvcform-recaptcha="recaptcha" class="dhvc-form-recaptcha dhvc-form-recaptcha2" data-name="'.$name.'" id="'.$name.'"></div>';
			$output .='
	<noscript>
		...
		');
		$output .='<div class="dhvc-form-recaptcha" data-dhvcform-recaptcha="recaptcha"  data-name="'.$name.'" id="'.$name.'"></div>';	
	}
