		...
		<table class="dhvc-form-paypal-table">
			...
			<tbody>
				...
				<tr>
					...
					<td class="paypal-item-price-value dhvc-form-math" data-result-math="<?php echo $item->price?>" data-value-math="<?php echo trim(esc_attr($item->price))?>" data-title="<?php echo esc_attr($price_text)?>">
						<?php echo dhvc_form_price($dhvc_form->ID,$item->price)?>
					</td>
				</tr>
				<?php endforeach;?>
			</tbody>
