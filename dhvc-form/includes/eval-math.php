...
if ( ! class_exists( 'DHVC_Form_Eval_Math', false ) ) {
	/**
	 * Class DHVC_Form_Eval_Math. Supports basic math only (removed eval function).
	 *
	 * Based on EvalMath by Miles Kaufman Copyright (C) 2005 Miles Kaufmann http://www.twmagic.com/.
	 */
	class DHVC_Form_Eval_Math {
		...
		private static function nfx( $expr ) {
			...
			$index = 0;
			$stack = new DHVC_Form_Eval_Math_Stack;
	...
	/**
	 * Class DHVC_Form_Eval_Math_Stack.
	 */
	class DHVC_Form_Eval_Math_Stack {
