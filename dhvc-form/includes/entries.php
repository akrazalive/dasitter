								...
								<div class="dhvcform_options">
									...
									if($form_control):
										...
										foreach ($form_control_arr as $control):
											...
											$control_name = isset($control['control_name'])? $control['control_name'] : null;
										
										 	if($control_name && isset($entry_data[$control_name])):
									...
									?>
											<div class="form-field">
												<label>
													<strong>
														<?php 
														$label = (!empty($control['control_label']) ? $control['control_label'] : $control_name);
														echo apply_filters('dhvc_form_view_entry_control_label', $label, $control, $entry);
														?>
													</strong>
												</label>
												<div>
												...
												if('dhvc_form_file' !== $control['tag']):
													if($control['tag'] === 'dhvc_form_password'):
														if(!apply_filters('dhvc_form_password_view_entry_password', false)):
															echo '*****';
														else:
															echo $entry_data[$control_name];
														endif;
													else:
														$value = is_array($entry_data[$control_name]) ? implode(', ', $entry_data[$control_name]) : $entry_data[$control_name];
														echo apply_filters('dhvc_form_view_entry_control_value', $value, $control, $entry);
													endif;
												elseif('dhvc_form_file' === $control['tag']):
